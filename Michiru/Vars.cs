...
public static class Vars {
    ...
    private static readonly Version VersionObj = new (1, 9, 2);
    ...
    public static readonly DateTime BuildTime = IsDebug ? DateTime.UtcNow : new DateTime(2024, 7, 20, ( 15 + 4 ), 51, 40);
