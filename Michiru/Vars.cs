...
public static class Vars {
    ...
    private static readonly Version VersionObj = new (1, 9, 3);
    ...
    public static readonly DateTime BuildTime = IsDebug ? DateTime.UtcNow : new DateTime(2024, 7, 27, ( 10 + 4 ), 6, 20);
