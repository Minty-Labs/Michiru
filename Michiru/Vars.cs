...
public static class Vars {
    ...
    public const string Version = "1.4.2" + (IsDebug ? "-dev" : ""); // Major.Feature.Minor/Bugfix.Hotfix
    public static readonly DateTime BuildTime = IsDebug ? DateTime.UtcNow : new DateTime(2024, 4, 4, 14, 58, 00);
