...
public static class Vars {
    ...
    public const string Version = "1.4.3" + (IsDebug ? "-dev" : ""); // Major.Feature.Minor/Bugfix.Hotfix
    public static readonly DateTime BuildTime = IsDebug ? DateTime.UtcNow : new DateTime(2024, 4, 7, 10, 39, 00);
