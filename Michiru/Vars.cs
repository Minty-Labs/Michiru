...
public static class Vars {
    ...
    private static readonly Version VersionObj = new (1, 9, 4);
    ...
    public static readonly DateTime BuildTime = IsDebug ? DateTime.UtcNow : new DateTime(2024, 8, 17, ( 8 + 4 ), 46, 00);
